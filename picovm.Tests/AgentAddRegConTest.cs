...
{
    /// <summary>
    /// Coverage for <c>ADD_REG_CON</c> (<c>ADD reg, imm</c>) across every register width, on
    ...
    /// </summary>
    public class AgentAddRegConTest
    {
    ...
    /// <summary>64-bit mirror of <see cref="AgentAddRegConTest"/>, plus the RAX-width case.</summary>
    public class Agent64AddRegConTest
    {
        private static string[] Program(string reg, string v1, string v2) => Asm.Text(
            $"MOV {reg}, {v1}",
            $"ADD {reg}, {v2}",
