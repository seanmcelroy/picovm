...
{
    public readonly struct BytecodeTextSymbol64 : IBytecodeTextSymbol
    {
        ...
        public UInt64 TextSegmentInstructionOffset { get; }
        ...
        public UInt64 TextSegmentReferenceOffset { get; }
        ...
        public BytecodeTextSymbol64(string name, UInt64 textSegmentInstructionOffset, UInt64 textSegmentReferenceOffset, byte referenceLength)
        {
            this.Name = name;
